...
# response = client.messages.create(model=MODEL, max_tokens=100, messages=messages)
# print(response)
...
class Chatbot:
	...
	def chat(self, message):
		...
		r = self.client.messages.create(model=MODEL, max_tokens=500, messages=self.history)
